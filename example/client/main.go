...
import (
	...
	grpc_client "github.com/zly-app/grpc/client"
...
func main() {
	...
	c := grpc_client.NewGRpcClientCreator(app) // 获取grpc客户端建造者
	// 注册客户端创造者
	c.RegistryGRpcClientCreator("hello", func(cc grpc_client.ClientConnInterface) interface{} {
